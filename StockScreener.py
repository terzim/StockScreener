...
class StockScreener(object):
    ...
    CRITERIA1 = "" # placeholder
    CRITERIA2 = "" # placeholder
    CRITERIA3 = "" # placeholder
    CRITERIA4 = "" # placeholder
    CRITERIA5 = "" # placeholder
    ...
    CRITERIA1_MIN = 0 # placeholder
    CRITERIA1_MAX = 0 # placeholder

    CRITERIA2_MIN = 0 # placeholder
    CRITERIA2_MAX = 0 # placeholder

    CRITERIA3_MIN = 0 # placeholder
    CRITERIA3_MAX = 0 # placeholder

    CRITERIA4_MIN = 0 # placeholder
    CRITERIA4_MAX = 0 # placeholder

    CRITERIA5_MIN = 0 # placeholder
    CRITERIA5_MAX = 0 # placeholder
...
if __name__ == '__main__':
    ...
    # Set absolute path
    screener_bot_path = os.path.dirname(os.path.abspath(__file__))
    ...
    fileName = os.path.join(screener_bot_path, config['screener_data']['json_file'])
    csvfile = os.path.join(screener_bot_path, config['screener_data']['csv_file'])
